...
export function AddRooms() {
  const addRoomTranslation = useTranslation('addRooms');
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-6/7 sm:w-1/2 md:w-3/7 lg:w-1/4 xl:w-1/5">
        <section>
          <Select
            ...
            placeholder={addRoomTranslation.t('gu') as string}
        ...
        <section>
          <Select
            ...
            placeholder={addRoomTranslation.t('dong') as string}
            disabled={!watch('gu')}
        ...
        <div className="py-[64px]">
          ...
          <Input
            placeholder={addRoomTranslation.t('max') as string}
            type="number"
          ...
          <div className="mt-[28px] mb-[4px]">
            <Typography variant="header" fontStyle="semiBold">
              {addRoomTranslation.t('monthRent')}
            </Typography>
          </div>
          <div className="flex justify-between items-center mb-[20px]">
            <Typography variant="label" fontStyle="semiBold" customClassName="text-[16px]">
              {addRoomTranslation.t('includeMainFee')}
            </Typography>
          ...
          <div className="mb-[8px]">
            <Input
              placeholder={addRoomTranslation.t('monthMin') as string}
              type="number"
          ...
          <Input
            placeholder={addRoomTranslation.t('monthMax') as string}
            type="number"
        ...
        <div className="mt-[72px] mb-[4px]">
          <Typography variant="header" fontStyle="semiBold">
            {addRoomTranslation.t('dateAvailable')}
          </Typography>
        </div>
        <div className="flex justify-between items-center mb-[20px]">
          <Typography variant="label" fontStyle="semiBold" customClassName="text-[16px]">
            {addRoomTranslation.t('viewRoomsAvailable')}
          </Typography>
          <Toggle className="ml-2" register={register('dateAvailable')} />
        </div>
        <div className="mb-[16px]">
          <Input
            placeholder={addRoomTranslation.t('mmddyyyy') as string}
            type="text"
        ...
        <div className="mt-[32px] mb-[4px]">
          <Typography variant="header" fontStyle="semiBold">
            {addRoomTranslation.t('typeOfHousing')}
          </Typography>
        </div>
        <div className="grid grid-cols-2 gap-[8px] mt-[12px]">
          <Checkbox
            type="outlined"
            label={addRoomTranslation.t('studio') as string}
            register={register('studioChecked')}
            checked={watch('studioChecked')}
          />
          <Checkbox
            type="outlined"
            label={addRoomTranslation.t('bedFlats') as string}
            register={register('bedFlatsChecked')}
            checked={watch('bedFlatsChecked')}
          />
          <Checkbox
            type="outlined"
            label={addRoomTranslation.t('shareHouse') as string}
